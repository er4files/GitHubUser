package com.dev.githubuser.receiver
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        fun sendNotification(context: Context) {
            val intent = context.packageManager.getLaunchIntentForPackage("com.dev.githubuser")
    ...
    fun setRepeatingAlarm(context: Context?, type: String, time: String, message: String) {
        if (context == null || isDateInvalid(time, TIME_FORMAT)) return
